...
package dev.kyleescobar.runetools.asm.editor;
...
public class Instruction implements Opcode {
	...
	public Instruction(final int opcode, final Object operand) {
		...
		Assert.isTrue(opcode == opcXMap[opcode], "Illegal instruction: "
				+ this);
	}
	...
	public boolean isSwitch() {
		return opcodeClass() == opcx_switch;
	}
	...
	public String toString() {
		if ((operand == null) && (opcodeClass() != opcx_ldc)) {
			return opcNames[opcode];
		} else if (operand instanceof Float) {
			return opcNames[opcode] + " " + operand + "F";
		} else if (operand instanceof Long) {
			return opcNames[opcode] + " " + operand + "L";
			...
			return opcNames[opcode] + " \"" + sb.toString() + "\"";

		} else {

			return opcNames[opcode] + " " + operand;
		}
	}
