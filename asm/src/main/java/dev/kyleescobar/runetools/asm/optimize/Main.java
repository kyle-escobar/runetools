...
package dev.kyleescobar.runetools.asm.optimize;

import dev.kyleescobar.runetools.asm.cfg.DominatorTree;
import dev.kyleescobar.runetools.asm.cfg.FlowGraph;
import dev.kyleescobar.runetools.asm.cfg.VerifyCFG;
import dev.kyleescobar.runetools.asm.codegen.CodeGenerator;
import dev.kyleescobar.runetools.asm.codegen.Liveness;
import dev.kyleescobar.runetools.asm.codegen.RegisterAllocator;
import dev.kyleescobar.runetools.asm.context.BloatContext;
import dev.kyleescobar.runetools.asm.context.CachingBloatContext;
import dev.kyleescobar.runetools.asm.diva.InductionVarAnalyzer;
import dev.kyleescobar.runetools.asm.editor.*;
import dev.kyleescobar.runetools.asm.file.ClassFile;
import dev.kyleescobar.runetools.asm.file.ClassFileLoader;
import dev.kyleescobar.runetools.asm.inline.StackHeightCounter;
import dev.kyleescobar.runetools.asm.reflect.ClassFormatException;
import dev.kyleescobar.runetools.asm.reflect.MethodInfo;
import dev.kyleescobar.runetools.asm.ssa.SSA;
import dev.kyleescobar.runetools.asm.ssa.SSAGraph;
import dev.kyleescobar.runetools.asm.tbaa.TypeInference;
import dev.kyleescobar.runetools.asm.trans.*;
import dev.kyleescobar.runetools.asm.tree.StackOptimizer;
import dev.kyleescobar.runetools.asm.tree.Tree;
