...
import dev.kyleescobar.runetools.asm.reflect.Constant;
...
import dev.kyleescobar.runetools.asm.util.Graph;
import dev.kyleescobar.runetools.asm.util.GraphNode;
...
public class ClassHierarchy {
	...
	private void addClass(final String name) {
		 ...
		 * 
		 * dev.kyleescobar.runetools.asm.depend.TypeNode typeNode =
